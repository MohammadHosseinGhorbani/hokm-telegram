...
app.add_handler(CommandHandler('newgame', newgame_command, filters.ChatType.GROUPS))
...
app.add_handler(MessageHandler(~filters.FORWARDED & filters.VIA_BOT, sticker_handler))
...
app.add_handler(CommandHandler('announce', announce_command, filters.ChatType.GROUPS))
app.add_handler(CommandHandler('leave', leave_command, filters.ChatType.GROUPS))
app.add_handler(CallbackQueryHandler(replace_button, r'^replace_'))
app.add_handler(CommandHandler('end', end_command, filters.ChatType.GROUPS))
